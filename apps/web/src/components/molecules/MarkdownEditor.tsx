...
export function MarkdownEditor({ id, value, onChange, error, placeholder = '使用 Markdown 描述内容…', minRows = 8, onPasteImage }: EditorProps) {
  ...
  return <div className={`overflow-hidden rounded-lg border bg-white focus-within:ring-2 focus-within:ring-brand-600/25 ${error ? 'border-red-500' : 'border-slate-300'}`}>
