...
export function CommentComposer({ onSubmit, onPasteImage, loading, error }: { onSubmit: (body: string) => void; onPasteImage?: (file: File) => Promise<string>; loading?: boolean; error?: string }) {
