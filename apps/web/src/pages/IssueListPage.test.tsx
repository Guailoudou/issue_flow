...
describe('Issue 导出筛选', () => {
  it('保留非状态筛选并携带关闭时间范围', () => {
    const filters: Filters = { q: '登录', status: 'CLOSED', assignee: '2', author: '3', label: '4,6', milestone: '5', sort: 'created-asc' };
    ...
    expect(Object.fromEntries(params)).toEqual({ q: '登录', authorId: '3', assigneeId: '2', labelIds: '4,6', milestoneId: '5', sort: 'createdAt', order: 'asc', closedFrom: new Date('2026-08-01T00:00:00.000').toISOString(), closedTo: new Date('2026-08-31T23:59:59.999').toISOString() });
